...
function hideBasedOnSelected(dropdownList){
    const value = dropdownList.value; // lekérjük a lenyíló menü értékét
    const cardClass = dropdownList.parentElement.querySelectorAll(".card"); // lekérjük a szülőelemben található összes card osztályú elemet

    for(const i of cardClass)
    { 
        i.classList.add("hide");
    }
    makeVisibleBasedOnId(dropdownList.parentElement, value);
}
